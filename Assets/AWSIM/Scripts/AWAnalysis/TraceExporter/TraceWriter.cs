...
namespace AWSIM.AWAnalysis.TraceExporter
{
    public abstract class TraceWriter
    {
        ...
        protected readonly AutowareVPPAdapter _egoAdapter;
            ...
            PerceptionMode perceptionMode, TraceCaptureConfig config)
        {
            ...
            _egoAdapter = EgoSingletonInstance.AutowareEgoCarAdapter;
        ...
        protected virtual void UpdateTraceObject(double timeStamp)
        {
            ...
            newState.groundtruth_ego.pose.position = new Vector3Object(_egoAdapter.Position.x, _egoAdapter.Position.y, _egoAdapter.Position.z);
            var egoRotation = _egoAdapter.Rotation.eulerAngles;
            ...
            newState.groundtruth_ego.twist.linear = new Vector3Object(_egoAdapter.Velocity.x, _egoAdapter.Velocity.y, _egoAdapter.Velocity.z);
            newState.groundtruth_ego.twist.angular = new Vector3Object(_egoAdapter.AngularVelocity.x, _egoAdapter.AngularVelocity.y, _egoAdapter.AngularVelocity.z);
            
            newState.groundtruth_ego.acceleration = new AccelerationObject();
            newState.groundtruth_ego.acceleration.linear = new Vector3Object(_egoAdapter.Acceleration.x, _egoAdapter.Acceleration.y, _egoAdapter.Acceleration.z);
            ...
            for (int i = 0; i < npcCount; i++)
            {
                ...
                {
                    var distanceToEgo = CustomSimUtils.DistanceIgnoreYAxis(npc.Position, _egoAdapter.Position);
            ...
            for (int i = 0; i < pedesCount; i++)
            {
                ...
                if (_perceptionMode == PerceptionMode.CAMERA_LIDAR_FUSION)
                {
                    var distanceToEgo = CustomSimUtils.DistanceIgnoreYAxis(entry.Item1.LastPosition, _egoAdapter.Position);
                    if (distanceToEgo < _maxDistanceVisibleOnCamera &&
